import svgPaths from "./svg-evyhx78n74";
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="결제내역 상세 12">
      ...
      <div className="absolute content-stretch flex flex-col items-start left-[14.98px] top-[274.99px] w-[330.041px]">
          ...
          <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[101.733px]">
            <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-full">
              <div className="bg-[#f3f4f6] content-stretch flex flex-col items-center justify-center overflow-clip px-[6px] py-[5px] relative rounded-[30px] shrink-0">
                <p className="font-['Pretendard:Medium',sans-serif] leading-none not-italic relative shrink-0 text-[#191a1c] text-[10px] text-center tracking-[-0.4px] whitespace-nowrap">구내식당</p>
              </div>
      ...
      <div className="absolute bg-[#f7f8fa] content-stretch flex h-[64px] items-center justify-center left-0 px-[82px] py-[24px] top-[50.49px] w-[360px]">
        <p className="font-['Pretendard:Bold',sans-serif] leading-none not-italic relative shrink-0 text-[#ee2b2f] text-[15px] text-center tracking-[-0.15px] whitespace-nowrap">결제취소</p>
      </div>
